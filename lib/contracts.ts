...
// Contract addresses - Fresh deployment on Chiliz Spicy Testnet (ChainID: 88882)
export const CONTRACT_ADDRESSES = {
  TRICOLOR_PASS: process.env.NEXT_PUBLIC_TRICOLOR_PASS_ADDRESS || '0x218e55aeF350110f7b95ec1EB2e9ef3175CbDEF4',
  QUEST_MANAGER: process.env.NEXT_PUBLIC_QUEST_MANAGER_ADDRESS || '0xFBdb303D86C9d0FB19D651C5374BCAFfBF168eC8',
  REWARD_DISTRIBUTOR: process.env.NEXT_PUBLIC_REWARD_DISTRIBUTOR_ADDRESS || '0x841F0DAe8493844b227b7eCB2Fb6ea77a4A2d6e9',
  MOCK_SPFC_TOKEN: process.env.NEXT_PUBLIC_MOCK_SPFC_TOKEN_ADDRESS || '0x3c05A2De1449F2C113499A97fa7BeDF64165C5b0',
  SPFC_TOKEN: process.env.NEXT_PUBLIC_SPFC_TOKEN_ADDRESS || '0x3c05A2De1449F2C113499A97fa7BeDF64165C5b0', // Use working MockSPFC for demo
};
